...
public class EGIPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        loadConfig();
        new EGIAddon(this).registerCommands();
        new EGIAddon(this).registerEvents();
    }

    private void loadConfig() {
        try {
            config = YamlDocument.create(
                    new File(new EGIAddon(this).getDataFolder(), "config.yml"),
    ...
    private boolean registerAddon() {
        EGIAddon addon = new EGIAddon(this);
